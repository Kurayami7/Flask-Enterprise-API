#testing the api for grades
from requests import get, post
# Module variables to connect to moodle api
KEY = "Your token, find it in moodle web services"
URL = "Your own Moodle/LMS Web URL"
ENDPOINT="/webservice/rest/server.php" #change if needed
